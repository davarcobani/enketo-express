...
----------------------
##### Added
- Ability to [add custom widgets](https://github.com/davarcobani/enketo-express/blob/master/doc/custom-widgets.md) or [remove default widgets](https://github.com/davarcobani/enketo-express/tree/master/config#widgets) in config.json. **Have an issue? Check whether your config.json contains an old "widgets" property. If so, you'll probably want to just remove it.**
...
---------------------
##### Added
- Advanced and regular single submission webform views and API endpoints. **WARNING: requires [additional configuration item](https://github.com/davarcobani/enketo-express/blob/master/config/README.md#less-secure-encryption-key)!**
...
- Duplicate Enketo Ids are issued. **WARNING: This is a critical fix. [Recommended to deploy immediately!](https://github.com/davarcobani/enketo-express/blob/master/doc/duplicates.md)**
- Unfixable state of surveys with duplicate Enketo Id. ([Tool](https://github.com/davarcobani/enketo-express/blob/master/doc/duplicates.md) added to fix) **
